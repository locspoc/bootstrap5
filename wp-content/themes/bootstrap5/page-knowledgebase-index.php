...
/**
 * Template Name: Knowledgebase Index
 *
 * @package kadence
 */
...
<main>
    <div class="container mt-3 mb-5">
        ...
        <h2 class="text-center mb-4">Most read articles</h2>
        <div class="row">
            <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-lg-0">
                <div class="card">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/700x500.png" alt="Article image" class="card-img-top">
                    <div class="card-body text-center">
                        <h3 class="card-title h5"><a href="<?= home_url('knowledgebase-article'); ?>">Article Heading</a></h3>
                        <div class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus a odio nisi.</div>
                    </div><!-- / card-body -->
                </div><!-- / card -->
            </div><!-- / col-12 -->
            <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-lg-0">
        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-sm-5">
                <h3 class="h5"><a href="<?= home_url('knowledgebase-category'); ?>">Category Heading</a></h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus a odio nisi.</p>
            </div><!-- / col-12 -->
            <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-sm-5">
                <h3 class="h5"><a href="<?= home_url('knowledgebase-category'); ?>">Category Heading</a></h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus a odio nisi.</p>
